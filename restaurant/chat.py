...
class RestaurantChatBot(ChatBot):
    ...
    def get_initial_chat(self, ai_prompt, customer_prompt):
        ...
        customer_chat = [
          ...
          {"role": "user", "content": "Hello! Welcome to our restaurant recommendation service. How can I help you?"},
        ]
    ...
    def get_wm_simulation(self, wm_prompt, choice):
        ...
        choice_to_words =  {"A": "User selected Option A", "B": "User selected Option B", "C": "User selected Option C", "D": "User decided not to choose any restaurant"}

        chat = [
          {"role": "system", "content": wm_prompt},
          {"role": "user", "content": f"{choice_to_words[choice]}. Describe the customer's outcome after dining at the restaurant they chose."},
        ]
