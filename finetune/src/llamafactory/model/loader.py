...
def load_model(
    ...
    if model is None and not lazy_load:
        ...
        # init_kwargs["pretrained_model_name_or_path"] = "./models/llama3_lora_dpo"
        # xx = "./models/llama3_lora_dpo"
        # model = AutoModelForCausalLM.from_pretrained(xx)
        # tokenizer = AutoTokenizer.from_pretrained(xx)
